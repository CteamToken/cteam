Contributing to CTEAM
============================

The cteam project operates an open contributor model where anyone is
...
The following applies to code changes to the CTEAM project, and is not to be
confused with overall CTEAM Network Protocol consensus changes.

Whether a pull request is merged into CTEAM rests with the project merge
...
Patches that change CTEAM consensus rules are considerably more involved than
...
Where a patch set proposes to change the CTEAM consensus, it must have been
...
The project leader is the release manager for each CTEAM release.
