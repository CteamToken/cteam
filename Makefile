...
pkgdatadir = $(datadir)/cteam
pkgincludedir = $(includedir)/cteam
pkglibdir = $(libdir)/cteam
pkglibexecdir = $(libexecdir)/cteam
...
ACLOCAL = ${SHELL} /home/cteam/cteam/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/cteam/cteam/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/cteam/cteam/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/cteam/cteam/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/cteam/cteam/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = cteam
PACKAGE_BUGREPORT = www.Christian.team 
PACKAGE_NAME = CTEAM
PACKAGE_STRING = CTEAM 1.0.0
PACKAGE_TARNAME = cteam
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/cteam/cteam
abs_srcdir = /home/cteam/cteam
abs_top_builddir = /home/cteam/cteam
abs_top_srcdir = /home/cteam/cteam
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/cteam/cteam/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/cteamd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/cteam-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/cteam-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = CTEAM-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_cteam_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_cteam_coverage.info test_cteam.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/cteam-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/cteam-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/cteam-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/cteam-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_cteam.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_cteam -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_cteam_filtered.info: test_cteam.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_cteam_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_cteam_coverage.info: baseline_filtered_combined.info test_cteam_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_cteam_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_cteam_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_cteam_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_cteam.coverage/.dirstamp:  test_cteam_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_cteam.coverage/.dirstamp total.coverage/.dirstamp

# cteam: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_cteam.coverage/ total.coverage/ $(OSX_APP)
