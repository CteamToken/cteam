...
In order to support loading of multiple wallets in cteam-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cteam.cpp.
...
Changes to cteam.cpp
----------------------
cteam.cpp is the entry point into cteam-qt, and as such, will require some minor modifications to provide hooks for
