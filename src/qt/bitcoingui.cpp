                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Christian Team") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cteam address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cteam: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Christian Team"), this);
    aboutAction->setStatusTip(tr("Show information about Christian Team"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for cteam"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cteam addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cteam addresses"));
    ...
    openAction->setStatusTip(tr("Open a cteam: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Christian Team help message to get a list with possible command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Christian Team client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cteam network", "", count));
}
...
{
    QString strTitle = tr("Christian Team"); // default title
