...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::CTEAM);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeCteamAmount"))
        SoftSetArg("-anonymizecteamamount", settings.value("nAnonymizeCteamAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in cteam.cpp during shotdown to also remove the window positions
