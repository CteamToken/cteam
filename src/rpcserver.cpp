...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* cteam features */
        {"cteam", "masternode", &masternode, true, true, false},
        {"cteam", "masternodelist", &masternodelist, true, true, false},
        {"cteam", "mnbudget", &mnbudget, true, true, false},
        {"cteam", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cteam", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cteam", "mnsync", &mnsync, true, true, false},
        {"cteam", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cteam", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cteamd, or the -server option to cteam-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
